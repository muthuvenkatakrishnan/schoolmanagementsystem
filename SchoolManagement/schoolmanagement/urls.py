...
urlpatterns = [
    ...
    path("calendar_view", views.calendar_view, name="calendar"),
    path("teacher_calendar_view", views.teacher_calendar_view, name="calendar"),
    path("student_calendar_view", views.student_calendar_view, name="calendar"),
